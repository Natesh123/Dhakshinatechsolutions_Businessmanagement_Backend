...
exports.generateInvoicePDF = exports.generateReceiptPDF = exports.generateQuotationPDF = void 0;
// @ts-nocheck
const pdfkit_1 = __importDefault(require("pdfkit"));
const Quotation_1 = require("../models/Quotation");
const QuotationItem_1 = require("../models/QuotationItem");
const CompanySetting_1 = require("../models/CompanySetting");
...
function generateProfessionalHeader(doc, settings, documentTitle, details) {
...
function generateBillToSection(doc, client, startY = 150) {
    const primaryColor = '#0f172a';
    const secondaryColor = '#64748b';
...
const generateQuotationPDF = async (quotationId, res) => {
    try {
        const quotation = await Quotation_1.Quotation.findByPk(quotationId, {
            include: [
        ...
        const settings = await CompanySetting_1.CompanySetting.findOne();
...
const generateReceiptPDF = async (paymentId, res) => {
    try {
        const payment = await Payment_1.Payment.findByPk(paymentId, {
            include: [
                { model: Client_1.Client, as: 'client' },
                {
                    model: Invoice_1.Invoice,
                    as: 'invoice',
                    include: [{ model: Project_1.Project, as: 'project' }]
                }
            ]
        });
        if (!payment) {
...
const generateInvoicePDF = async (invoiceId, res) => {
    try {
        const invoice = await Invoice_1.Invoice.findByPk(invoiceId, {
            include: [
                { model: Client_1.Client, as: 'client' },
